...
porém na Figura \@ref(fig:fig-top) avalia-se a variável isoladamente, no modelo para interpretarmos o coeficiente de uma variável fixamos os valores das outras, portanto a correlação existente entre as variáveis influência no valor do coeficientes estimados. 
